  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-xl md:text-2xl mb-16 text-center font-normal uppercase" style={{ color: '#0C5C38' }}>
          ...
          {days.map((day) => (
            ...
            >
              ...
              <div className="flex-1 relative z-10">
                <h3 className="text-xl font-black mb-3 uppercase group-hover:text-green-600 transition-colors" style={{ color: '#0C5C38' }}>
                  {day.title}
                </h3>
                <p className="text-base leading-relaxed opacity-80 font-semibold" style={{ color: '#2F2F2F' }}>{day.description}</p>
              </div>
            </div>
          ))}
        </div>
        <div className="max-w-5xl mx-auto p-12 rounded-3xl border-2 shadow-xl relative overflow-hidden" style={{ backgroundColor: '#F8F9FA', borderColor: '#E5E5E5' }}>
          ...
          <div className="relative z-10">
            <div className="text-center mb-10 p-6 bg-white rounded-2xl border-2 shadow-sm" style={{ borderColor: '#75DEAF' }}>
              <h3 className="text-2xl md:text-3xl font-black uppercase" style={{ color: '#0C5C38' }}>Кожен день:</h3>
            </div>
