  ...
  return (
    <section className="py-24 px-6 grain-texture grain-texture-green" style={{ backgroundColor: '#75DEAF' }}>
      <div className="max-w-6xl mx-auto text-white">
        ...
        <p className="text-xl md:text-2xl mb-12 text-center max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="p-8 rounded-2xl bg-white/10 backdrop-blur-sm border-2 border-white/30 text-center hover:bg-white/20 transition-all hover:scale-110 transform shadow-lg relative overflow-hidden group">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3 relative z-10">Чат підтримки</h3>
            <p className="opacity-90 text-lg relative z-10">з іншими учасницями</p>
          </div>
          <div className="p-8 rounded-2xl bg-white/10 backdrop-blur-sm border-2 border-white/30 text-center hover:bg-white/20 transition-all hover:scale-110 transform shadow-lg relative overflow-hidden group">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3 relative z-10">Зідзвон на старті</h3>
            <p className="opacity-90 text-lg relative z-10">для визначення та усвідомлення цілей</p>
          </div>
          <div className="p-8 rounded-2xl bg-white/10 backdrop-blur-sm border-2 border-white/30 text-center hover:bg-white/20 transition-all hover:scale-110 transform shadow-lg relative overflow-hidden group">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3 relative z-10">Зідзвон у фіналі</h3>
            <p className="opacity-90 text-lg relative z-10">відповіді на питання + ефір "як втримати результат і не злити початок року"</p>
          </div>
        </div>
      </div>
    </section>
